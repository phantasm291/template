            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.html" class="logo">
                        <span>
                            <strong><u>GPG LAND MASTER</u></strong>
                        </span>
                        <i>
                           <strong class="text-dark">GPG</strong>
                        </i>
                    </a>
                </div>
                ...
                <nav class="navbar-custom bg-info">
                    ...
                    <ul class="navbar-right d-flex list-inline float-right mb-0">
                        <li class="dropdown notification-list d-none d-sm-block">
                            <form role="search" class="app-search">
                                <div class="form-group mb-0"> 
                                    <input type="text" class="form-control bg-dark for-placholder" placeholder="Search.." style="border-radius: 5px;border:none;">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <i class="mdi mdi-bell noti-icon text-dark"></i>
                                <span class="badge badge-pill badge-info noti-icon-badge text-dark bg-primary">3</span>
                            </a>
                    ...
                    <ul class="list-inline menu-left mb-0">
                        <li class="float-left">
                            <button class="button-menu-mobile open-left waves-effect waves-light bg-info text-dark">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active">Welcome to Agent Dashboard</li>
                                    </ol>
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-md-6">
                                    <a href="index.html">
                                        ...
                                        <div class="card-body for-table1">
                                            <div class="mini-stat-desc">
                                                <h6 class="text-uppercase verti-label text-white-50">BACK LOGS</h6>
                                                <div class="text-white">
                                                    <h6 class="text-uppercase mt-0 text-white-50">BACK LOGS</h6>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card bg-info mini-stat position-relative">
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                <h6 class="text-uppercase verti-label text-white-50">PROCESSING</h6>
                                                <div class="text-white">
                                                    <h6 class="text-uppercase mt-0 text-white-50">PROCESSING</h6>
                                                    <h3 class="mb-3 mt-0">3</h3>
                                                    <div class="">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card bg-info mini-stat position-relative">
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                <h6 class="text-uppercase verti-label text-white-50">COMPLETED</h6>
                                                <div class="text-white">
                                                    <h6 class="text-uppercase mt-0 text-white-50">COMPLETED</h6>
                                                    <h3 class="mb-3 mt-0">0</h3>
                                                    <div class="">
